...
function NavBar() {
	...
	return (
		<nav className="flex justify-between items-center px-4 relative pb-4">
			...
			<ul className="hidden lg:flex text-base lg:text-lg xl:text-2xl font-semibold gap-2 lg:gap-4 xl: relative box-border">
				{navs.map((item, index) => (
					<li key={index}>
						<a
							href={item.url}
